...
// `demo/book.ron` enables `hardbreaks`, where newline is translated as `<br>`.
// If not, newlines are treated as wrapped text and if you want to insert `<br>`, you have to add
// ` +` to end of a line.
